      ...
      <Container>
          ...
          <Col className={Styles.firstcol}>
            ...
            <div className={Styles.trddiv}>
              <div className={Styles.fourimgess}>
                <Image  src="../images/first.png" alt="abc"></Image >
              </div>
              <div className={Styles.fourimgess}>
                <Image  src="../images/second.png" alt="abc"></Image >
              </div>{" "}
              <div className={Styles.fourimgess}>
                <Image  src="../images/third.png" alt="abc"></Image >
              </div>{" "}
              <div className={Styles.fourimgess}>
                <Image  src="../images/fourth.png" alt="abc"></Image >
              </div>
            </div>
          </Col>
          <Col>
        ...
        <Row className={Styles.navigfooter}>
          <Col className={Styles.gapppp}>
            <Image  alt="abc" src="../images/Home.png" />
            <Image  alt="abc" src="../images/shop.png" />
          </Col>
          <Col className={Styles.gapppp}>
            <Image  alt="abc" src="../images/Group (1).png" />
