      ...
      <Container>
        <Row className={Styles.rowcol}>
          <Col className={Styles.firstcol}>
            <div>
              {" "}
              <img className={Styles.googleimg} src="../images/google.png" />
            </div>
            ...
            <div className={Styles.trddiv}>
              ...
              <img src="../images/facebgroup.png"></img>
              <img src="../images/instagroup.png"></img>
              <img src="../images/linkdingroup.png"></img>
            </div>
          </Col>
          <Col>
            <div>
