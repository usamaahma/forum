          ...
          <Col>
            ...
            <div className={Styles1.displdeshiservice}>
              <div className={Styles1.conddis}>
                <div>
                  <p className={Styles1.txtgap}> Condition</p>
                  <Dropdown
                    menu={{
                      items,
                    }}
                    ...
                    arrow
                  >
                    <Button className={Styles1.wdthi}>
                      New
                      <DownOutlined />
                    </Button>
                  </Dropdown>
              ...
              <div>
                <p className={Styles1.txtgaps}> Price Type</p>
                <Dropdown
                  menu={{
                    items,
                  }}
                  ...
                  arrow
                >
                  <Button className={Styles1.wdthinputtts}>
                    Fixed
                    <DownOutlined />
                  </Button>
                </Dropdown>
