...
function BuySellForm({ initialValues }) {
  ...
  const handleBuySellDescriptionChange = (value) => {
    form.setFieldsValue({ buySellDescription: value });
  };
  const onChange = (e) => {
  ...
  const onFinish = async (values) => {
    ...
    buySellForm({
      ...
      .then((res) => {
        ...
        localStorage.removeItem("buysellFormData");
        setUrl("");
        setTags([]);
        setFeatureDetails([]);
      })
  ...
  return (
    <div>
      ...
      <div className={Styles.mainhero}>
        <div>
          <h1 className={Styles.centerhero}>Add Buy And Sell</h1>
          <p className={Styles.colrgreen}>Home / Add Buy And Sell</p>
        </div>
      </div>{" "}
      <div>
        ...
        <Row justify={"center"}>
          ...
          >
            <Col>
              ...
              <div className={Styles1.displdeshiservice}>
                ...
                <div>
                  <Form.Item name="deliveryType">
                    <div className={Styles.divssss}>
                      <p style={{ marginTop: "-.1rem" }}> Delivery Type</p>
                      <Select
                        defaultValue="cod"
                        style={{
                          width: "20rem",
              ...
              <div className={Styles1.displdeshiservic}>
                <Form.Item name="buySellDescription">
                  <div>
                    Buy&Sell Description
                    <DynamicReactQuill
                      value={text1}
                      onChange={handleBuySellDescriptionChange}
                    />
                  </div>
                </Form.Item>
              </div>
